...
if __name__ == "__main__":
    ...
    mapping = convert(
        from_path="manual_mapping/csv_files/arena_maze.csv",
    ...
    mapping = convert(
        from_path="manual_mapping/csv_files/sector_maze.csv",
    ...
    mapping = convert(
        from_path="manual_mapping/csv_files/game_object_maze.csv",
    ...
    mapping = convert(
        from_path="manual_mapping/csv_files/spawning_location_maze.csv",
    ...
    mapping = convert(
        from_path="manual_mapping/csv_files/collision_maze.csv",
