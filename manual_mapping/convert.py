...
if __name__ == "__main__":
    maze_files = [
        "manual_mapping/to_convert/arena_maze.csv",
    ...
    mapping_files = [
        "manual_mapping/mapping/arena_mapping.json",
    ...
    output_files = [
        "manual_mapping/converted/arena_maze.csv",
    ...
    for maze_file, mapping_file, output_file in zip(
        maze_files, mapping_files, output_files
    ):
