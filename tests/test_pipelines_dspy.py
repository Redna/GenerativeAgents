...
class TestDSPyPipelines(unittest.TestCase):
    ...
    def test_decide_to_talk(self):
        ...
        # Run function
        result = decide_to_talk(
            "Context", "Time", "Me", "You", "Summary", "ObsMe", "ObsYou"
        )
    ...
    def test_hourly_breakdown(self):
        ...
        from generative_agents.conversational.pipelines.hourly_breakdown import (
            create_hourly_schedule,
        )

        result = create_hourly_schedule(
            "Agent",
            "Identity",
            [{"time": "08:00 AM", "activity": "Wake up"}],
            "08:00 AM",
        )
    ...
    def test_task_decomposition(self):
        ...
        from generative_agents.conversational.pipelines.task_decomposition import (
            create_decomposition_schedule,
        )

        result = create_decomposition_schedule(
            "Agent", "Id", "Task", "9:00", "10:00", 60, "Today", "Ctx"
        )
    ...
    def test_action_location_arena(self):
        ...
        from generative_agents.conversational.pipelines.action_location_arena import (
            action_area_locations,
        )

        result = action_area_locations(
            "Agent", "bedroom", "Sector", "Other", "kitchen, bathroom", "Cooking"
        )
    ...
    def test_action_location_sector(self):
        ...
        from generative_agents.conversational.pipelines.action_location_sector import (
            action_sector_locations,
        )

        result = action_sector_locations(
            "Agent", "Home", "Rooms", "Current", "Rooms", "Park, Shop", "Walk"
        )
    ...
    def test_action_location_object(self):
        ...
        with patch("dspy.Predict") as mock_predict:
            ...
            from generative_agents.conversational.pipelines.action_location_game_object import (
    ...
    def test_action_event_triple(self):
        ...
        from generative_agents.conversational.pipelines.action_event_tripple import (
            action_event_triple,
        )
    ...
    def test_action_pronunciatio(self):
        ...
        from generative_agents.conversational.pipelines.action_pronunciatio import (
            action_pronunciatio,
        )
    ...
    def test_contextualize_event(self):
        ...
        from generative_agents.conversational.pipelines.contextualize_event import (
            contextualize_event,
        )
    ...
    def test_conversation(self):
        ...
        from generative_agents.conversational.pipelines.conversation import (
            run_conversation,
        )

        utt, end = run_conversation(
            "Agent", "Id", "Mem", "Ctx", "Loc", "Act", "With", "Act2", "Hist"
        )
    ...
    def test_conversation_summary(self):
        ...
        from generative_agents.conversational.pipelines.conversation_summary import (
    ...
    def test_evidence_and_insights(self):
        ...
        from generative_agents.conversational.pipelines.evidence_and_insights import (
    ...
    def test_first_daily_plan(self):
        ...
        from generative_agents.conversational.pipelines.first_daily_plan import (
            create_daily_plan,
        )
    ...
    def test_identity(self):
        ...
        from generative_agents.conversational.pipelines.identity import (
            formulate_identity,
        )
    ...
    def test_memo_on_conversation(self):
        ...
        from generative_agents.conversational.pipelines.memo_on_conversation import (
            memo_on_conversation,
        )
    ...
    def test_new_decomposition_schedule(self):
        ...
        from generative_agents.conversational.pipelines.new_decomposition_schedule import (
            create_new_decomposition_schedule,
        )

        # Helper to create dummy schedule slice
        slice_input = [("Old Task", 60)]
        result = create_new_decomposition_schedule(
            "Name", 9, 10, "New Event", 30, slice_input
        )
    ...
    def test_object_event(self):
        ...
        from generative_agents.conversational.pipelines.object_event import (
    ...
    def test_planning_on_conversation(self):
        ...
        from generative_agents.conversational.pipelines.planning_on_conversation import (
    ...
    def test_reflection_points(self):
        ...
        from generative_agents.conversational.pipelines.reflection_points import (
            reflection_points,
        )
    ...
    def test_summarize_chat_relationship(self):
        ...
        from generative_agents.conversational.pipelines.summarize_chat_relationship import (
